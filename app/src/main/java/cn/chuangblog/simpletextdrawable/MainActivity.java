...
import cn.chuangblog.simpletextdrawable.simple.DataItem;
import cn.chuangblog.simpletextdrawable.simple.DataSource;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (item.getNavigationInfo() != DataSource.NO_NAVIGATION) {
                holder.textView.setCompoundDrawablesWithIntrinsicBounds(null,
                        null,
                        getResources().getDrawable(R.mipmap.ic_action_next_item),
                        null);
            }
            else {
                holder.textView.setCompoundDrawablesWithIntrinsicBounds(null,
